...
const IndexPage = () => {
  return(
          ...
          if (matches) {
            ...
            return(
              ...
              <div className="Hero">
                ...
                {/* First Section */}
                <div className="Section1" data-aos="fade" data-aos-delay="50"
    data-aos-duration="1000">
                ...
                {/* Second Section */}
                <div className="Section1-right" data-aos="fade" data-aos-delay="50"
    data-aos-duration="1000">
                  <div className="SectionText" id="addfriends">
                    <h1>
                      Add friends
    ...
    data-aos-duration="1000">
                ...
                <div className="Testimonial" data-aos="fade" data-aos-delay="50"
    data-aos-duration="1000">
                <img id="confetti-1" src={require('../images/confetti.svg')} width='45' />
                <img id="confetti-2" src={require('../images/confetti.svg')} width='45' />
                <p id="testimonial">
